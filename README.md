...
We solved the following LP problem using a very naive method since we did an exhaustive search over basic feasible solutions of this LP. Basic feasible solutions are vertices of constraint polytope, here an hypercube of dimension d with 2^d vertices. we generate vertices as binary arrays on the fly and evaluate them.
